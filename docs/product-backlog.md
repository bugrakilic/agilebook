...
The Product Backlog is an ordered list of everything that might be needed in the product. It is the single source of work to be done. Its commitment is the Product Goal — the future state of the product the Scrum Team plans toward.

## Characteristics

- Dynamic and evolving based on changing requirements and feedback  
- Prioritized by the Product Owner to maximize value toward the Product Goal  
- Contains features, fixes, technical work, and knowledge acquisition  

## Ownership

- Owned and managed by the Product Owner  
- Developers collaborate to refine and estimate items  
